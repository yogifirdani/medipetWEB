        ...
        <div class="section-body">
            ...
            <form action="{{ route('catalogs.index') }}" method="GET" class="mb-4">
                <div class="input-group">
                    <input type="text" name="q" class="form-control" placeholder="Cari produk..." value="{{ request('search') }}">
                        ...
                        <article class="article">
                            ...
                            <div class="article-details">
                                ...
                                <div class="article-cta">
                                    <a href="{{ route('catalogs.show', $product->id) }}" class="btn btn-primary">Lihat Detail</a>
